...
> **Phase: B — Grooming (active since 2026-04-27).** No product code yet. MVP-1 surface still pending. **STORY-008 + STORY-010 + STORY-011 done** (32 decisions D-12..D-43; ADRs 0002 + 0003 accepted). **STORY-009 in progress** — architecture grooming. **7 of ~14 ADRs accepted so far**: ADR-0004 multi-tenancy, ADR-0005 event bus + saga (Kafka-shaped), ADR-0006 observability (OTel + Langfuse), ADR-0007 auth provider (Auth.js MVP-1), ADR-0011 LLM Gateway (policy enforcement, not router), ADR-0017 status / brand / admin-UI. **D-12..D-49 logged** (49 total decisions). Remaining: ADR-0008..0010+0012 AI subsystems, ADR-0013..0016+0018 plugin + AI mechanisms + cross-cutting + ML platform + data quality.
