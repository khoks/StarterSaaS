...
> **Phase: B — Grooming (active since 2026-04-27).** No product code yet. MVP-1 surface still pending. **STORY-008 + STORY-010 + STORY-011 done** (32 decisions D-12..D-43; ADRs 0002 + 0003 accepted). **STORY-009 in progress** — architecture grooming. **11 of ~14 ADRs accepted so far**: ADR-0004 multi-tenancy, ADR-0005 event bus + saga (Kafka-shaped), ADR-0006 observability (OTel + Langfuse), ADR-0007 auth provider (Auth.js MVP-1), ADR-0008 AI Sub 1 Customer Profile Builder, ADR-0009 AI Sub 2 Context-Resolving Query, ADR-0010 AI Sub 3 Agent Platform, ADR-0011 LLM Gateway, ADR-0012 AI Sub 5 AI Coworker, ADR-0017 status / brand / admin-UI. **D-12..D-53 logged** (53 total decisions). Q6 closes STORY-009 with: ADR-0013 plugin spec + ADR-0014 AI-assisted merge + ADR-0015 AI-assisted config gen + ADR-0016 ai-ui integration + ADR-0018 deploy portal mechanism + ML platform + data quality.
