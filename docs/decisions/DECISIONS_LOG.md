...
| repo-topology | Monorepo + workspaces (assistant-recommended) vs. true polyrepo for kit dev. Publishing topology already locked as polyrepo-shaped (D-16) | STORY-010 |
| package-manager | npm / pnpm / yarn / Cargo / Go modules — depends on stack pick | STORY-010 |
